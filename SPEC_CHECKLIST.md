...
| OPR-10 | 복구 checkpoint·원격 안전망 | 01 순서11 | 새 commit/tag/bundle verify·재clone; origin recovery branch/tag SHA 일치; main 불변 | ls-remote·bundle verify·clone fsck | [ ] | |
| OPR-11 | PM2 서비스 정상화 | 01 순서12 | brain-server/teamengram-org-brain/monitor/clo online, 새 PID·기대 cwd, crash loop 0 | sanitized PM2·health/log | [ ] | |
| OPR-12 | 실제 사용자 경로 스모크 | 01 운영 시나리오 | Brain health→write→recall·Raw/JSONL/DB, monitor 신규2 사실 기록·증가0, Telegram 인증+개인 실송신 1건 | API·파일·DB·message id | [ ] | |
| OPR-13 | 종료 독립 감사 | 01 순서14 | 원문 재대조, 14/14, fresh 회귀, rollback 증거·원격 ref·서비스, LOOP_END | 동일 세션 자기감사·증거 실물 | [ ] | |
