...
| MAX-06 | 잔여 유형 분류 | `01-runbook.md` 순서7 | 잔여를 scope/type/sourceRef/generator별 분류하고 분류 합계=monitor missing 수 | classification JSON·합계 assertion | [x] | 총 8,241=work-log 6,483+session-handoff 1,655+전용 생성기 없음 103; scope/type/sourceFamily/generator/canonical 전수 분류·합계 assertion PASS; `MAX-06-classification.json` |
